...
function session(options) {
  ...
  var cookieOptions = opts.cookie || {}  // cookie 相关配置，可以参考 “cookie-parser” https://www.npmjs.com/package/cookie-parser

  // get the session id generate function
  var generateId = opts.genid || generateSessionId  // 生成session id，默认是用 "uid-safe"，也可用自定义算法，前提是生成的id不会冲突。

  // get the session cookie name
  var name = opts.name || opts.key || 'connect.sid'  // session id会存储在cookie里返回给客户端，opts.name 即对应的 cookie 名
